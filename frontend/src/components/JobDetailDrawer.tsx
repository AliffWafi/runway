        ...
        <div className="bg-[#ebdbb2] border border-[#3c3836] p-3 rounded-sm mb-4 grid grid-cols-1 sm:grid-cols-2 gap-3 shadow-[2px_2px_0px_#3c3836]">
          ...
          <div className="flex items-center gap-2 relative">
            ...
            <div className="relative">
              ...
              >
                {currentStatusConfig.label} {currentStatusConfig.sublabel}
                <ChevronDown className="w-3 h-3" />
              </button>

              {isStatusDropdownOpen && (
                <div className="absolute left-0 top-full mt-1 z-50 border-2 border-[#3c3836] shadow-[3px_3px_0px_#3c3836] bg-[#282828] min-w-[190px]">
                  {statusKeys.map((key) => {
                    ...
                    return (
                      ...
                      >
                        {optConfig.label} {optConfig.sublabel}
                      </div>
                    );
                  })}
                </div>
